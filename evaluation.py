...
def piece_value(piece, square):
    ...
    if symbol == 'p':
        score *= (100 + pawn[pos[0]][pos[1]])
    elif symbol == 'n':
        score *= (280 + knight[pos[0]][pos[1]])
    elif symbol == 'b':
        score *= (320 + bishop[pos[0]][pos[1]])
    elif symbol == 'r':
        score *= (350 + rook[pos[0]][pos[1]])
    elif symbol == 'q':
        score *= (929 + queen[pos[0]][pos[1]])
    elif symbol == 'k':
        score *= (60000 + king[pos[0]][pos[1]])
